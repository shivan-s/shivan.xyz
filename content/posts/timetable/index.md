...
<script>
    ...
    import Storybook from "./storybook.gif"
    import Demo from "./demo.gif"
    import ColourSeed01 from "./colour-seed-01.gif"
    import ColourSeed02 from "./colour-seed-02.gif"
    import Base64 from "./base64.gif"
</script>

The pole studio I attend offer a variety of classes focusing on skills, to flex, to flow all organised in a timetable.
...
<Figure src={ColourSeed01} alt="Timetable grid changing colours with a page refresh" caption="Grid of colours" />
...
<Figure src={ColourSeed02} alt="Two Items called 'Test' have the same colour. Two new items are created 'Test 1' and 'Test 2' with different colours" caption="Text dictates the colour" />
...
<Figure src={Base64} alt="A new browser tab is opened and a link is pasted with the base64 string as the url parameter and prepopulated timetable appears" caption="Data stored in the url" />
