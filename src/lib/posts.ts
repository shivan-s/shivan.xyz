...
const paths = import.meta.glob('../../content/posts/**/index.md', {
	eager: true,
	query: { enhanced: true }
});
...
export type PostsGroupByYear = ReturnType<typeof fetchPostsGroupByYear>;
/**
 * Fetch posts in a groupby for year - good for a list view
 */
export function fetchPostsGroupByYear() {
	const posts = fetchAllPost();
